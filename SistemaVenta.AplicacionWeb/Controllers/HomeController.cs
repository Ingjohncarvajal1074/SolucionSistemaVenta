...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(IMapper mapper, IUsuarioService usuarioServicio)
        {
            _mapper = mapper;
        ...
        public async Task<IActionResult> ObtenerUsuario()
        {
            ...
            try
            {
                ...
                string usuarioId = claimUser.Claims.Where(c => c.Type == ClaimTypes.NameIdentifier)
                    .Select(c => c.Value).SingleOrDefault();

                VMUsuario usuario = _mapper.Map<VMUsuario>(await _usuarioServicio.ObtenerPorId(int.Parse(usuarioId)));
